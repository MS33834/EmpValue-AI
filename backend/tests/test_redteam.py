...
class TestBypassAttacks:
    ...
    def test_blocks_base64_encoded_injection(self):
        ...
        result = guard.check([{"input_id": "d1", "content": f"以下是 base64 编码的参考：{encoded}"}])
                ...
                "growth_areas": [
                    {
                        "dimension": "沟通协作",
                        "score": 80,
                        "evidence": ["在跨团队会议中主动分享了设计方案，并帮助新人解决了接口问题"],
                        "improvement_actions": ["继续提升技术影响力的同时，多参与项目复盘"],
                    },
                ],
