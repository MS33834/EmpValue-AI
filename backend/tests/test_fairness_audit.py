...
from scripts.fairness_audit import audit_fairness, main
...
def _records_by_department():
    """构造按部门分组的合成评估记录。"""
    return [
        {"employee_id": "E001", "department": "Engineering", "level": "L2", "overall_score": 80},
        {"employee_id": "E002", "department": "Engineering", "level": "L2", "overall_score": 82},
        {"employee_id": "E003", "department": "Engineering", "level": "L3", "overall_score": 84},
        {"employee_id": "E004", "department": "Sales", "level": "L2", "overall_score": 70},
        {"employee_id": "E005", "department": "Sales", "level": "L2", "overall_score": 72},
        {"employee_id": "E006", "department": "Sales", "level": "L3", "overall_score": 74},
    ]
...
class TestCliEntry:
    ...
    def test_cli_runs_and_writes_report(self, tmp_path):
        ...
        proc = subprocess.run(
            [sys.executable, "-m", "scripts.fairness_audit",
             "--input", str(input_path), "--output", str(report_path)],
            cwd=str(BACKEND_DIR),
            capture_output=True,
            text=True,
        )
